                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
                        <div className="text-center">
                            ...
                            <h3 className="text-2xl font-light mb-4 text-[#90172a]">BRITISH MANUFACTURING</h3>
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-2xl font-light mb-4 text-[#90172a]">PRECISION & QUALITY</h3>
                            <p className="text-gray-700">
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-2xl font-light mb-4 text-[#90172a]">SUSTAINABLE PRACTICES</h3>
                            <p className="text-gray-700">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-16 max-w-5xl mx-auto">
                        ...
                        <div>
                            ...
                            <p className="text-[#90172a] mb-4">Co-Founder & Creative Director</p>
                        ...
                        <div>
                            ...
                            <p className="text-[#90172a] mb-4">Co-Founder & Design Director</p>
                            <p className="text-gray-700 leading-relaxed">
